(() => {
  ...
  Object.assign(dictionaries["pt-BR"].meta, { title: "InstaCheck — Análise de conexões do Instagram", description: "Analise seguidores, seguindo e conexões no Instagram e acompanhe mudanças ao longo do tempo. Sem login e com processamento local." });
  Object.assign(es.meta, { title: "InstaCheck — Análisis de conexiones de Instagram", description: "Analiza seguidores, seguidos y conexiones en Instagram y sigue los cambios a lo largo del tiempo. Sin inicio de sesión y con procesamiento local." });
  Object.assign(en.meta, { title: "InstaCheck — Instagram connection analysis", description: "Analyze followers, following and Instagram connections, and track changes over time. No login and local processing." });

  Object.assign(dictionaries["pt-BR"].hero, { eyebrow: "Análise completa, local e privada", title: "Entenda suas conexões no Instagram.", description: "Analise seguidores, seguindo, conexões mútuas e acompanhe mudanças ao longo do tempo — sem login e com processamento local." });
  Object.assign(es.hero, { eyebrow: "Análisis completo, local y privado", title: "Entiende tus conexiones en Instagram.", description: "Analiza seguidores, seguidos, conexiones mutuas y sigue los cambios a lo largo del tiempo, sin iniciar sesión y con procesamiento local." });
  Object.assign(en.hero, { eyebrow: "Complete, local and private analysis", title: "Understand your Instagram connections.", description: "Analyze followers, following, mutual connections, and track changes over time — with no login and local processing." });

  Object.assign(dictionaries["pt-BR"].upload, { button: "Analisar minhas conexões" });
  Object.assign(es.upload, { button: "Analizar mis conexiones" });
  Object.assign(en.upload, { button: "Analyze my connections" });

  dictionaries["pt-BR"].features = { eyebrow: "Uma visão completa", title: "O que o InstaCheck analisa", followersTitle: "Seguidores", followersText: "Veja sua lista e acompanhe mudanças.", followingTitle: "Seguindo", followingText: "Entenda as contas com as quais você mantém conexão.", mutualsTitle: "Conexões mútuas", mutualsText: "Veja quem você segue e também segue você.", nonFollowersTitle: "Não seguem de volta", nonFollowersText: "Veja contas que você segue, mas que não seguem você.", newTitle: "Novos seguidores", newText: "Compare análises e veja quem começou a seguir.", lostTitle: "Deixaram de seguir", lostText: "Identifique mudanças desde sua análise anterior.", historyTitle: "Histórico", historyText: "Acompanhe como suas conexões mudaram ao longo do tempo." };
  es.features = { eyebrow: "Una visión completa", title: "Lo que analiza InstaCheck", followersTitle: "Seguidores", followersText: "Consulta tu lista y sigue sus cambios.", followingTitle: "Seguidos", followingText: "Entiende las cuentas con las que mantienes conexión.", mutualsTitle: "Conexiones mutuas", mutualsText: "Mira a quién sigues y también te sigue.", nonFollowersTitle: "No te siguen", nonFollowersText: "Mira las cuentas que sigues pero que no te siguen.", newTitle: "Nuevos seguidores", newText: "Compara análisis y descubre quién empezó a seguirte.", lostTitle: "Dejaron de seguirte", lostText: "Identifica cambios desde tu análisis anterior.", historyTitle: "Historial", historyText: "Sigue cómo cambian tus conexiones con el tiempo." };
  en.features = { eyebrow: "A complete view", title: "What InstaCheck analyzes", followersTitle: "Followers", followersText: "View your list and track changes.", followingTitle: "Following", followingText: "Understand the accounts you stay connected with.", mutualsTitle: "Mutual connections", mutualsText: "See who you follow and who follows you back.", nonFollowersTitle: "Not following back", nonFollowersText: "See accounts you follow that do not follow you.", newTitle: "New followers", newText: "Compare analyses and see who started following.", lostTitle: "Unfollowed you", lostText: "Identify changes since your previous analysis.", historyTitle: "History", historyText: "Track how your connections change over time." };

  Object.assign(dictionaries["pt-BR"].guide, { description: "Siga estas etapas. Você pode sair do Instagram enquanto o arquivo é preparado.", step5Title: "Solicite e aguarde", step5Text: "Confirme a exportação. O Instagram pode levar alguns minutos para preparar o arquivo; você não precisa ficar esperando nessa tela.", step6Title: "Baixe quando receber o aviso", step6Text: "O Instagram enviará uma notificação e/ou e-mail. Volte à exportação e toque em <strong>Baixar</strong>.", step7Title: "Encontre o ZIP e volte", step7Text: "No celular, procure em <strong>Downloads</strong>. Em Android/Samsung: <strong>Meus Arquivos → Downloads</strong>. Não descompacte; volte ao InstaCheck e selecione o ZIP." });
  Object.assign(es.guide, { description: "Sigue estos pasos. Puedes salir de Instagram mientras se prepara el archivo.", step5Title: "Solicita y espera", step5Text: "Confirma la exportación. Instagram puede tardar algunos minutos; no necesitas quedarte esperando en esa pantalla.", step6Title: "Descarga cuando recibas el aviso", step6Text: "Instagram enviará una notificación y/o correo. Vuelve a la exportación y toca <strong>Descargar</strong>.", step7Title: "Encuentra el ZIP y vuelve", step7Text: "En el móvil, busca en <strong>Descargas</strong>. En Android/Samsung: <strong>Mis archivos → Descargas</strong>. No lo descomprimas; vuelve a InstaCheck y selecciona el ZIP." });
  Object.assign(en.guide, { description: "Follow these steps. You can leave Instagram while the file is prepared.", step5Title: "Request and wait", step5Text: "Confirm the export. Instagram may take a few minutes; you do not need to stay on that screen.", step6Title: "Download after the notification", step6Text: "Instagram will send a notification and/or email. Return to the export and tap <strong>Download</strong>.", step7Title: "Find the ZIP and return", step7Text: "On mobile, look in <strong>Downloads</strong>. On Android/Samsung: <strong>My Files → Downloads</strong>. Do not extract it; return to InstaCheck and select the ZIP." });

  dictionaries["pt-BR"].faq = { eyebrow: "Dúvidas rápidas", title: "Perguntas frequentes", waitQuestion: "Preciso esperar o Instagram preparar o arquivo?", waitAnswer: "Não. Você pode sair da tela e voltar quando receber a notificação ou o e-mail.", unzipQuestion: "Preciso descompactar o ZIP?", unzipAnswer: "Não. Selecione o arquivo ZIP original diretamente no InstaCheck.", loginQuestion: "O InstaCheck pede login ou senha?", loginAnswer: "Nunca. Os arquivos são processados somente neste dispositivo e não são enviados para um servidor.", historyQuestion: "Onde meu histórico fica salvo?", historyAnswer: "No navegador deste dispositivo. Baixe um backup JSON antes de limpar os dados do navegador ou trocar de aparelho.", contact: "Ainda precisa de ajuda? Fale comigo no Instagram →" };
  es.faq = { eyebrow: "Dudas rápidas", title: "Preguntas frecuentes", waitQuestion: "¿Tengo que esperar a que Instagram prepare el archivo?", waitAnswer: "No. Puedes salir y volver cuando recibas la notificación o el correo.", unzipQuestion: "¿Tengo que descomprimir el ZIP?", unzipAnswer: "No. Selecciona el ZIP original directamente en InstaCheck.", loginQuestion: "¿InstaCheck pide usuario o contraseña?", loginAnswer: "Nunca. Los archivos se procesan solo en este dispositivo y no se envían a un servidor.", historyQuestion: "¿Dónde se guarda mi historial?", historyAnswer: "En el navegador de este dispositivo. Descarga una copia JSON antes de borrar los datos o cambiar de dispositivo.", contact: "¿Todavía necesitas ayuda? Háblame por Instagram →" };
  en.faq = { eyebrow: "Quick answers", title: "Frequently asked questions", waitQuestion: "Do I need to wait for Instagram to prepare the file?", waitAnswer: "No. You can leave and return after receiving the notification or email.", unzipQuestion: "Do I need to extract the ZIP?", unzipAnswer: "No. Select the original ZIP directly in InstaCheck.", loginQuestion: "Does InstaCheck ask for a login or password?", loginAnswer: "Never. Files are processed only on this device and are not sent to a server.", historyQuestion: "Where is my history stored?", historyAnswer: "In this device's browser. Download a JSON backup before clearing browser data or changing devices.", contact: "Still need help? Message me on Instagram →" };

  Object.assign(dictionaries["pt-BR"].actions, { demo: "Ver demonstração", backHome: "Voltar ao início", backAccounts: "Voltar às contas", viewHistory: "Ver histórico", openAnalysis: "Abrir análise", deleteAnalysis: "Excluir análise", shareResult: "Compartilhar resultado" });
  Object.assign(es.actions, { demo: "Ver demostración", backHome: "Volver al inicio", backAccounts: "Volver a las cuentas", viewHistory: "Ver historial", openAnalysis: "Abrir análisis", deleteAnalysis: "Eliminar análisis", shareResult: "Compartir resultado" });
  Object.assign(en.actions, { demo: "View demo", backHome: "Back to home", backAccounts: "Back to accounts", viewHistory: "View history", openAnalysis: "Open analysis", deleteAnalysis: "Delete analysis", shareResult: "Share result" });

  dictionaries["pt-BR"].demo = { homeHelp: "Explore todas as listas com dados fictícios", badge: "Demonstração · dados fictícios", summary: "Você está explorando uma análise completa com dados de demonstração. Nada será salvo no seu histórico.", dataLabel: "Dados de demonstração · nenhuma informação real", source: "Demonstração do InstaCheck", historyTitle: "Exemplo de histórico", historyHelp: "Duas análises fictícias mostram como a comparação funciona. Nada será salvo." };
  es.demo = { homeHelp: "Explora todas las listas con datos ficticios", badge: "Demostración · datos ficticios", summary: "Estás explorando un análisis completo con datos de demostración. No se guardará nada en tu historial.", dataLabel: "Datos de demostración · ninguna información real", source: "Demostración de InstaCheck", historyTitle: "Ejemplo de historial", historyHelp: "Dos análisis ficticios muestran cómo funciona la comparación. No se guardará nada." };
  en.demo = { homeHelp: "Explore every list with fictional data", badge: "Demo · fictional data", summary: "You are exploring a complete analysis with demo data. Nothing will be saved to your history.", dataLabel: "Demo data · no real information", source: "InstaCheck demo", historyTitle: "History example", historyHelp: "Two fictional analyses show how comparisons work. Nothing will be saved." };

  Object.assign(dictionaries["pt-BR"].history, { openLatestHelp: "Escolha uma conta e uma análise salva", hubTitle: "Meu histórico", hubDescription: "Escolha uma conta para ver e abrir suas análises salvas.", savedAnalyses: "Análises salvas", savedCountOne: "1 análise salva", savedCountMany: "{count} análises salvas", lastAnalysis: "Última análise: {date}", savedOn: "Análise salva em {date}", deleteConfirm: "Excluir esta análise salva?\n\nOs dados desta análise serão removidos deste dispositivo. Essa ação não pode ser desfeita.", deleteLastConfirm: "Esta é a última análise salva desta conta. Ao excluir, a conta também sairá do histórico deste dispositivo.\n\nDeseja continuar?", deleted: "Análise salva excluída.", followersBalance: "saldo de seguidores", followingChange: "variação seguindo", firstTitle: "Primeira análise salva", firstDescription: "Na próxima importação desta conta, compararemos as mudanças com esta análise.", comparisonWith: "Comparando com a análise de {date}.", automatic: "As análises de @{username} são comparadas automaticamente.", empty: "Nenhuma análise salva ainda.", latest: "Análise mais recente · {date}", title: "Histórico de análises", subtitle: "Cada nova importação é comparada com a análise anterior.", openSnapshot: "Abrir resultados da análise de {date}" });
  Object.assign(es.history, { openLatestHelp: "Elige una cuenta y un análisis guardado", hubTitle: "Mi historial", hubDescription: "Elige una cuenta para ver y abrir sus análisis guardados.", savedAnalyses: "Análisis guardados", savedCountOne: "1 análisis guardado", savedCountMany: "{count} análisis guardados", lastAnalysis: "Último análisis: {date}", savedOn: "Análisis guardado el {date}", deleteConfirm: "¿Eliminar este análisis guardado?\n\nLos datos se eliminarán de este dispositivo. Esta acción no se puede deshacer.", deleteLastConfirm: "Este es el último análisis guardado de la cuenta. Al eliminarlo, la cuenta también saldrá del historial.\n\n¿Quieres continuar?", deleted: "Análisis guardado eliminado.", followersBalance: "saldo de seguidores", followingChange: "variación de seguidos", firstTitle: "Primer análisis guardado", firstDescription: "En la próxima importación compararemos los cambios con este análisis.", comparisonWith: "Comparando con el análisis del {date}.", automatic: "Los análisis de @{username} se comparan automáticamente.", empty: "Todavía no hay análisis guardados.", latest: "Análisis más reciente · {date}", title: "Historial de análisis", subtitle: "Cada importación se compara con el análisis anterior.", openSnapshot: "Abrir resultados del análisis del {date}" });
  Object.assign(en.history, { openLatestHelp: "Choose an account and a saved analysis", hubTitle: "My history", hubDescription: "Choose an account to view and open its saved analyses.", savedAnalyses: "Saved analyses", savedCountOne: "1 saved analysis", savedCountMany: "{count} saved analyses", lastAnalysis: "Latest analysis: {date}", savedOn: "Analysis saved on {date}", deleteConfirm: "Delete this saved analysis?\n\nIts data will be removed from this device. This cannot be undone.", deleteLastConfirm: "This is the last saved analysis for this account. Deleting it will also remove the account from this device's history.\n\nContinue?", deleted: "Saved analysis deleted.", followersBalance: "follower balance", followingChange: "following change", firstTitle: "First analysis saved", firstDescription: "The next import will compare changes with this analysis.", comparisonWith: "Compared with the analysis from {date}.", automatic: "Analyses for @{username} are compared automatically.", empty: "No saved analyses yet.", latest: "Latest analysis · {date}", title: "Analysis history", subtitle: "Each import is compared with the previous analysis.", openSnapshot: "Open analysis results from {date}" });

  Object.assign(dictionaries["pt-BR"].results, { snapshotSaved: "Análise de @{username} salva neste aparelho.", snapshotViewing: "Visualizando a análise salva em {date}. Nenhuma nova análise foi criada.", snapshotChip: "Análise de {date} · {source}" });
  Object.assign(es.results, { snapshotSaved: "Análisis de @{username} guardado en este dispositivo.", snapshotViewing: "Viendo el análisis guardado el {date}. No se creó un nuevo análisis.", snapshotChip: "Análisis del {date} · {source}" });
  Object.assign(en.results, { snapshotSaved: "Analysis for @{username} saved on this device.", snapshotViewing: "Viewing the analysis saved on {date}. No new analysis was created.", snapshotChip: "Analysis from {date} · {source}" });
  Object.assign(dictionaries["pt-BR"].results, { title: "Sua análise", initialSummary: "Explore todas as suas conexões e mudanças." });
  Object.assign(es.results, { title: "Tu análisis", initialSummary: "Explora todas tus conexiones y cambios." });
  Object.assign(en.results, { title: "Your analysis", initialSummary: "Explore all your connections and changes." });
  Object.assign(dictionaries["pt-BR"].account, { editHelp: "Corrija o username sem perder análises salvas, progresso ou comparações desta conta.", mergeNote: "Se já existir um histórico com esse username, as análises serão unidas sem duplicar." });
  Object.assign(es.account, { editHelp: "Corrige el usuario sin perder análisis guardados, progreso ni comparaciones.", mergeNote: "Si ya existe un historial para ese usuario, los análisis se unirán sin duplicados." });
  Object.assign(en.account, { editHelp: "Correct the username without losing saved analyses, progress, or comparisons.", mergeNote: "If history already exists for that username, analyses will be merged without duplicates." });
  Object.assign(dictionaries["pt-BR"].privacy, { zipText: "Salvamos somente análises das listas neste dispositivo. Depois, você pode apagar o ZIP." });
  Object.assign(es.privacy, { zipText: "Solo guardamos análisis de las listas en este dispositivo. Después puedes borrar el ZIP." });
  Object.assign(en.privacy, { zipText: "We only save list analyses on this device. You can delete the ZIP afterward." });
  Object.assign(dictionaries["pt-BR"].words, { snapshot: "análise salva", snapshots: "análises salvas" });
  Object.assign(es.words, { snapshot: "análisis guardado", snapshots: "análisis guardados" });
  Object.assign(en.words, { snapshot: "saved analysis", snapshots: "saved analyses" });
  Object.assign(dictionaries["pt-BR"].messages, { backupCreated: "Backup criado com suas análises salvas.", restoredOne: "1 análise salva restaurada.", restoredMany: "{count} análises salvas restauradas." });
  Object.assign(es.messages, { backupCreated: "Copia creada con tus análisis guardados.", restoredOne: "1 análisis guardado restaurado.", restoredMany: "{count} análisis guardados restaurados." });
  Object.assign(en.messages, { backupCreated: "Backup created with your saved analyses.", restoredOne: "1 saved analysis restored.", restoredMany: "{count} saved analyses restored." });

  dictionaries["pt-BR"].creator = { eyebrow: "Gostou do InstaCheck?", title: "Acompanhe as próximas atualizações e outros projetos.", instagram: "@viniohc no Instagram ↗" };
  es.creator = { eyebrow: "¿Te gustó InstaCheck?", title: "Sigue las próximas actualizaciones y otros proyectos.", instagram: "@viniohc en Instagram ↗" };
  en.creator = { eyebrow: "Enjoying InstaCheck?", title: "Follow future updates and other projects.", instagram: "@viniohc on Instagram ↗" };
  Object.assign(dictionaries["pt-BR"].footer, { madeBy: "Feito por" });
  Object.assign(es.footer, { madeBy: "Hecho por" });
  Object.assign(en.footer, { madeBy: "Made by" });

  dictionaries["pt-BR"].share = { eyebrow: "Imagem privada", title: "Compartilhar minha análise", description: "A imagem mostra apenas estatísticas. Nenhum username analisado será incluído.", story: "Story", post: "Post", preview: "Prévia da imagem compartilhável", generate: "Gerar e compartilhar", fallback: "Se o compartilhamento não estiver disponível, a imagem será baixada.", imageTitle: "Minha análise", imageSubtitle: "Minhas conexões no Instagram", localTitle: "100% processado no meu dispositivo", localText: "Sem login, sem senha e sem enviar minhas listas.", defaultText: "Analise e acompanhe suas conexões no Instagram com o InstaCheck.", downloaded: "Imagem baixada!", error: "Não foi possível gerar a imagem." };
  es.share = { eyebrow: "Imagen privada", title: "Compartir mi análisis", description: "La imagen solo muestra estadísticas. No incluirá ningún usuario analizado.", story: "Historia", post: "Publicación", preview: "Vista previa de la imagen para compartir", generate: "Generar y compartir", fallback: "Si no está disponible compartir, la imagen se descargará.", imageTitle: "Mi análisis", imageSubtitle: "Mis conexiones en Instagram", localTitle: "100% procesado en mi dispositivo", localText: "Sin inicio de sesión, sin contraseña y sin enviar mis listas.", defaultText: "Analiza y sigue tus conexiones de Instagram con InstaCheck.", downloaded: "¡Imagen descargada!", error: "No se pudo generar la imagen." };
  en.share = { eyebrow: "Private image", title: "Share my analysis", description: "The image only shows statistics. No analyzed username will be included.", story: "Story", post: "Post", preview: "Shareable image preview", generate: "Generate and share", fallback: "If sharing is unavailable, the image will be downloaded.", imageTitle: "My analysis", imageSubtitle: "My Instagram connections", localTitle: "100% processed on my device", localText: "No login, no password, and no lists uploaded.", defaultText: "Analyze and track your Instagram connections with InstaCheck.", downloaded: "Image downloaded!", error: "The image could not be generated." };
  Object.assign(dictionaries["pt-BR"].share, { download: "Baixar imagem", generate: "Compartilhar", fallback: "Você pode baixar a imagem diretamente ou abrir o compartilhamento do dispositivo." });
  Object.assign(es.share, { download: "Descargar imagen", generate: "Compartir", fallback: "Puedes descargar la imagen directamente o abrir las opciones para compartir del dispositivo." });
  Object.assign(en.share, { download: "Download image", generate: "Share", fallback: "Download the image directly or open your device's sharing options." });

  Object.assign(dictionaries["pt-BR"].datasets.lostFollowers, { description: "Pessoas presentes na análise anterior que não aparecem mais entre seus seguidores.", emptyDescription: "Nenhum seguidor desapareceu desde a análise anterior.", detected: "Presente na análise de {date}" });
  Object.assign(es.datasets.lostFollowers, { description: "Personas presentes en el análisis anterior que ya no aparecen entre tus seguidores.", emptyDescription: "Ningún seguidor desapareció desde el análisis anterior.", detected: "Presente en el análisis del {date}" });
  Object.assign(en.datasets.lostFollowers, { description: "People present in the previous analysis who no longer appear among your followers.", emptyDescription: "No follower disappeared since the previous analysis.", detected: "Present in the {date} analysis" });
  Object.assign(dictionaries["pt-BR"].datasets.newFollowers, { description: "Pessoas que passaram a aparecer desde a análise anterior.", emptyDescription: "Nenhuma conta nova apareceu desde a análise anterior." });
  Object.assign(es.datasets.newFollowers, { description: "Personas que aparecieron desde el análisis anterior.", emptyDescription: "No apareció ninguna cuenta nueva desde el análisis anterior." });
  Object.assign(en.datasets.newFollowers, { description: "People who appeared since the previous analysis.", emptyDescription: "No new account appeared since the previous analysis." });
